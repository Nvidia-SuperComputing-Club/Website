...
export const EventCountdown = ({ event }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-obsidian-900 via-obsidian-850 to-obsidian-950 border border-nvidia/30 p-6 md:p-8 shadow-nvidia-glow">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-nvidia/10 border border-nvidia/30 text-nvidia text-xs font-mono font-medium">
        ...
        <div className="lg:col-span-5 flex flex-col items-center lg:items-end justify-center space-y-5">
          ...
          {event.registrationUrl && (
            <a
              ...
              className="w-full sm:w-auto px-6 py-3 rounded-xl bg-nvidia hover:bg-nvidia-light text-black font-display font-bold text-sm shadow-nvidia-glow transition-all flex items-center justify-center gap-2 group"
            >
